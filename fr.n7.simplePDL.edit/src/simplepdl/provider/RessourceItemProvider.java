 ...
 * @generated
 */
public class RessourceItemProvider extends ProcessElementItemProvider {
	/**
	...
	protected void addCountPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ressource_count_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ressource_count_feature", "_UI_Ressource_type"),
				 SimplepdlPackage.Literals.RESSOURCE__COUNT,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Ressource.class)) {
			...
			case SimplepdlPackage.RESSOURCE__COUNT:
