 ...
 *   <li>{@link simplepdl.impl.RessourceImpl#getCount <em>Count</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RessourceImpl extends ProcessElementImpl implements Ressource {
	...
	public void setCount(int newCount) {
		...
		count = newCount;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimplepdlPackage.RESSOURCE__COUNT, oldCount, count));
	}
