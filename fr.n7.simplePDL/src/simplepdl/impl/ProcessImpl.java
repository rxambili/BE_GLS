 ...
 *   <li>{@link simplepdl.impl.ProcessImpl#getProcessElement <em>Process Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProcessImpl extends MinimalEObjectImpl.Container implements simplepdl.Process {
	...
	public EList<ProcessElement> getProcessElement() {
		if (processElement == null) {
			processElement = new EObjectContainmentEList<ProcessElement>(ProcessElement.class, this, SimplepdlPackage.PROCESS__PROCESS_ELEMENT);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SimplepdlPackage.PROCESS__PROCESS_ELEMENT:
