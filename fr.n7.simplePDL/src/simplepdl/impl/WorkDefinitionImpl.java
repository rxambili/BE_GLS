 ...
 *   <li>{@link simplepdl.impl.WorkDefinitionImpl#getAllocation <em>Allocation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition {
	...
	public EList<Allocation> getAllocation() {
		if (allocation == null) {
			allocation = new EObjectContainmentWithInverseEList<Allocation>(Allocation.class, this, SimplepdlPackage.WORK_DEFINITION__ALLOCATION, SimplepdlPackage.ALLOCATION__WORKDEFINITION);
		}
		return allocation;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__ALLOCATION:
