...
public class SimplepdlPackageImpl extends EPackageImpl implements SimplepdlPackage {
	 ...
	 * @generated
	 */
	public EAttribute getAllocation_Needed() {
	...
	public void createPackageContents() {
		...
		createEAttribute(allocationEClass, ALLOCATION__NEEDED);
	...
	public void initializePackageContents() {
		...
		initEReference(getProcess_ProcessElement(), this.getProcessElement(), null, "processElement", null, 0, -1, simplepdl.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getAllocation_Needed(), ecorePackage.getEInt(), "needed", null, 1, 1, Allocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (workDefinitionEClass, 
		   source, 
		   new String[] {
			 "constraints", "differentNames noEmptyName"
		   });	
		addAnnotation
		  (workSequenceEClass, 
		   source, 
		...
		addAnnotation
		  (ressourceEClass, 
		   source, 
		   new String[] {
			 "constraints", "countPositif differentNames"
		   });	
		addAnnotation
		  (allocationEClass, 
		   source, 
		   new String[] {
			 "constraints", "nonDepassement neededPositif"
		   });
	}
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation
		  (workSequenceEClass, 
		   ...
		   new String[] {
			 ...
			 "nonReflexive", "self.predecessor <> self.successor"
		   });	
		addAnnotation
		...
		addAnnotation
		  (allocationEClass, 
		   source, 
		   new String[] {
			 "nonDepassement", "needed <= self.ressource.count",
			 "neededPositif", "needed >= 0"
		   });
	}
