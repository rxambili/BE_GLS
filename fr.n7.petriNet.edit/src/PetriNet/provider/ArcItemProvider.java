...
public class ArcItemProvider extends PetriElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Arc_successor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Arc_successor_feature", "_UI_Arc_type"),
				 PetriNetPackage.Literals.ARC__SUCCESSOR,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPredecessorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Arc_predecessor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Arc_predecessor_feature", "_UI_Arc_type"),
				 PetriNetPackage.Literals.ARC__PREDECESSOR,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		Arc arc = (Arc)object;
		return getString("_UI_Arc_type") + " " + arc.isIsReadArc();
	}
