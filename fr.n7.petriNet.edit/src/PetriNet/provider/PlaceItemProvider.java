...
public class PlaceItemProvider extends NoeudItemProvider {
	...
	/**
	 * This adds a property descriptor for the Jeton feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addJetonPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Place_jeton_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Place_jeton_feature", "_UI_Place_type"),
				 PetriNetPackage.Literals.PLACE__JETON,
				 true,
				 false,
				 false,
